...
NUM_QUERIES=10
BENCHMARK_PATH="data/static_benchmark_malt.jsonl"
PROMPT_TYPE="few_shot_semantic"  # Add this line to define prompt_type
...
declare -A model_configs=(
    ["AzureGPT4Agent"]="level1 level2 :tmp_azure.jsonl"
)
